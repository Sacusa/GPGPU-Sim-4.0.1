#ifndef __DRAM_SCHED_HILL_CLIMBING__
#define __DRAM_SCHED_HILL_CLIMBING__
...
#define HILL_CLIMBING_INTERVAL_LENGTH 10000
#define HILL_CLIMBING_MAX_PIM_BATCH_SIZE 64

class hill_climbing_scheduler : public dram_scheduler {
 public:
  hill_climbing_scheduler(const memory_config *config, dram_t *dm,
 ...
 private:
  ...
  float m_prev_non_pim_completion_rate;
};
