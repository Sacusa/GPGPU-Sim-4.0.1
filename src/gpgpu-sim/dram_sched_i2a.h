#ifndef __DRAM_SCHED_I2A__
#define __DRAM_SCHED_I2A__
...
class i2a_scheduler : public dram_scheduler {
 public:
  i2a_scheduler(const memory_config *config, dram_t *dm, memory_stats_t *stats);
