#ifndef __DRAM_SCHED_QUEUE_H__
#define __DRAM_SCHED_QUEUE_H__
...
#define DRAM_SCHED_QUEUE_PHASE_LENGTH        1000
#define DRAM_SCHED_QUEUE_MEM_TIME_INCREMENTS 0.2f
#define DRAM_SCHED_QUEUE_OBJ_TOLERANCE       0.05

class queue_scheduler : public dram_scheduler {
 public:
  queue_scheduler(const memory_config *config, dram_t *dm,
