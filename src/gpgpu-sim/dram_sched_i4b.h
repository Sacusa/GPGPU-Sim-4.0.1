#ifndef __DRAM_SCHED_I4B__
#define __DRAM_SCHED_I4B__
...
#define I4B_NON_PIM_ARR_RATE_TOLERANCE 0.05
#define I4B_MAX_MEM_REQ_OCCUPANCY 0.8
#define I4B_MAX_PIM_BATCH_SIZE 64
#define I4B_MAX_INTERVAL_LENGTH 640000
#define I4B_MAX_INSTABILITY 5

class i4b_scheduler : public dram_scheduler {
 public:
  i4b_scheduler(const memory_config *config, dram_t *dm, memory_stats_t *stats);
