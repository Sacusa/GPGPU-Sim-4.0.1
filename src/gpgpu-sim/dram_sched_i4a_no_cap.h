#ifndef __DRAM_SCHED_I4A_NO_CAP__
#define __DRAM_SCHED_I4A_NO_CAP__
...
#define I4A_NO_CAP_INTERVAL_LENGTH 10000
#define I4A_NO_CAP_MAX_PIM_BATCH_SIZE 64

class i4a_no_cap_scheduler : public dram_scheduler {
 public:
  i4a_no_cap_scheduler(const memory_config *config, dram_t *dm,
